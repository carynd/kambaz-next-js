    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Heat milk.</li>
          <li>Add cocoa powder.</li>
          <li>Stir until smooth.</li>
          <li>Pour into a mug.</li>
      ...
      <div id="wd-images">
        ...
        <Image
          ...
          width={400}
          height={300}
          src="https://www.spacelaunchschedule.com/wp-content/uploads/Super-Heavy-B4-Starship-S20-fit-check-080621-SpaceX-9f-crop-c-1024x587.jpg"
