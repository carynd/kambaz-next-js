      ...
      <ListGroup>
        {todos.map((todo) => (
          <ListGroupItem key={todo.id}>
            <input type="checkbox" defaultChecked={todo.completed} className="form-check-input me-2 float-start" title="Mark todo as completed"
            ...
            <TiDelete onClick={() => deleteTodo(todo)} className="text-danger float-end me-2 fs-4" id="wd-delete-todo" />
